...
export default function EmptyTestimonial() {
  ...
  const testimonialContent = siteContent.testimonialsSection;
    ...
    <div className="w-full flex flex-col items-center justify-center py-24 px-4">
      <div className="mb-20 text-center">
        <h2
          ...
          <motion.span
            ...
            {testimonialContent.highlightedTitle}
            <motion.span
              animate={
                isHovered
                  ? {
              ...
              {testimonialContent.highlightedEmoji}
            </motion.span>
          </motion.span>
        </h2>
      </div>
      <div
        ...
        <motion.div
          ...
          <div className="relative w-full h-full">
            ...
            <div
              className="absolute inset-0 flex flex-col items-center justify-center pt-8 pointer-events-none">
      ...
      <div className="text-center space-y-4">
        <p className="text-xl text-foreground tracking-tight">
          {testimonialContent.emptyTitle} <br />
          <span className="text-muted-foreground text-lg">
            {testimonialContent.emptyDescription}
          </span>
        </p>
        <div className="flex flex-col items-center gap-4 bg-transparent">
          <a
            href={testimonialContent.cta.href}
            target="_blank"
            ...
            <div
              className="w-6 h-6 rounded-full bg-primary flex items-center justify-center text-primary-foreground transition-transform duration-300">
              <HugeiconsIcon icon={Add01Icon} size={16} strokeWidth={3} />
            </div>
            <span
              className="text-md font-medium text-foreground group-hover:text-primary transition-colors">
              {testimonialContent.cta.label}
            </span>
          </a>
        </div>
      </div>
...
const Page = () => (
  <div
    className="w-full h-full bg-linear-to-b from-white to-[#F5F5F7] rounded-xl border border-neutral-200 p-4">
