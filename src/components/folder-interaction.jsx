...
function FolderInteraction() {
  ...
  return (
    <div className="w-full  flex justify-center items-center">
      <div onClick={() => setIsOpen(!isOpen)} className="w-80 h-52 relative wrapper">
        <div
...
const Page = () => (
  <div
    className="w-full h-full bg-gradient-to-b from-[#E8E7F0] to-[#DCDAE8] rounded-xl shadow-lg p-3 sm:p-4">
